...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="d-flex justify-content-around buttons">
            <button type="button" class="btn btn-lg btn-primary mt-5" onclick="location.href='{{ route('permit_store') }}'">店舗申請一覧へGO ☞<br></button>
            <button type="button" class="btn btn-lg btn-primary mt-5" onclick="location.href='{{ route('permit_post') }}'">投稿一覧へGO ☞</button>
        </div>
    </body>
</html>
