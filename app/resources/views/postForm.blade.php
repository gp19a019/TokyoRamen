...
<div class="form-group mb-3">
    ...
    <div class="text-center">
        <input class="form-control form-control-lg" type="text" name="storeName" id="name" value="{{ $storeName  }}" aria-label="Disabled input example" readonly>
    </div>
</div>
...
<label for="exampleFormControlTextarea1" class="form-label form-contents" style="font-size:1.5vw;">レビュー、コメントなど</label>
  <textarea class="form-control form-control-lg" name="review" id="exampleFormControlTextarea1" rows="3" maxlength="250"></textarea>
</div>
